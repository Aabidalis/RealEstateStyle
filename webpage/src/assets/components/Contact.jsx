...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black flex flex-col items-center justify-center px-4 py-12">
      {/* Heading */}
      <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl text-white text-center mb-8 sm:mb-12">
        Get In Touch
      </h1>
      ...
      <form
        onSubmit={onSubmit}
        className="bg-gray-800 p-6 sm:p-12 md:p-16 rounded-2xl shadow-2xl w-full max-w-3xl space-y-6"
      >
        ...
        <button
          type="submit"
          className="w-full py-3 sm:py-4 bg-blue-600 hover:bg-blue-700 transition-all duration-300 text-white font-semibold rounded-lg shadow-lg"
        >
