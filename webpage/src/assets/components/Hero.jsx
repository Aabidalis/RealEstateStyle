  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
        ...
        <p className="max-w-3xl text-lg md:text-2xl text-gray-200 leading-relaxed mb-8">
        ...
        <button className="bg-gradient-to-r from-orange-400 to-yellow-400 text-white text-xl md:text-2xl font-semibold px-8 py-4 rounded-2xl shadow-lg hover:shadow-orange-500/50 hover:scale-105 transition-transform duration-300">
          Explore More
        </button>
      </div>
